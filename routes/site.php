...
Route::get("/shop/{product:slug}/checkout", [SiteController::class,"checkoutPage"])->middleware(LoginCheck::class)->name("checkout");
Route::post("/shop/{product:slug}/checkout", [SiteController::class,"createOrder"])->middleware(LoginCheck::class)->name("checkout.store");
